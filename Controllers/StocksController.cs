...
namespace TradingPub.Controllers
{
    public class StocksController : Controller
    {
        ...
        public StocksController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Price")] Stocks stocks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Price")] Stocks stocks)
        {
            if (id != stocks.ID)
            {
                return NotFound();
